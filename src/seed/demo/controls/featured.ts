...
/**
 * Original high-quality demo narratives preserved as the quality standard.
 * Family modules must not redefine these control IDs.
 */
export function featuredNarratives(): DemoNarrativeMap {
  return {
