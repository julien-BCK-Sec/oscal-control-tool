 ...
 */
export const SUPPORTED_NIST_SP80053_REV5_PROFILE_FEATURES = [
  "profile.uuid",
  "profile.metadata",
...
/** @deprecated Use SUPPORTED_NIST_SP80053_REV5_PROFILE_FEATURES. */
...
/**
 * Derive the application Framework from a pinned NIST SP 800-53 Rev. 5
 * profile + catalog.
 *
 ...
 */
export function deriveNistSp80053Rev5Framework(
  profileRoot: unknown,
  catalogRoot: unknown,
  identity: Pick<NistSp80053Rev5Identity, "id" | "title" | "source">,
...
/**
 * Derive the Moderate baseline. Kept for existing tests and the historical
 * Moderate-only call sites.
 */
export function deriveNistModerateFramework(
  profileRoot: unknown,
  catalogRoot: unknown,
): FrameworkDerivationResult {
  return deriveNistSp80053Rev5Framework(
    profileRoot,
    catalogRoot,
    NIST_MODERATE_IDENTITY,
  );
